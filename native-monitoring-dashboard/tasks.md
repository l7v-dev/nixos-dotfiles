...
- [x] 1. NixOS konfigürasyonu güncelle
  - [x] 1.1 Grafana yerel modunu laptop konfigürasyonundan kaldır
    - `hosts/laptop/default.nix` içindeki `l7v.services.grafana { enable = true; localMode = true; }` bloğunu sil
    - _Requirements: 1.1_

  - [x] 1.2 Laptop'ta Prometheus ve prometheusWidget'ı etkinleştir
  ...
  - [x] 1.3 `modules/services/grafana/default.nix`'ten localMode kaldır
  ...
  - [x] 1.4 `panel/nix/module.nix`'ten `/grafana/` nginx location bloğunu kaldır
  ...
  - [x] 1.5 Checkpoint: Nix değerlendirmesini doğrula
...
- [x] 2. Go agent — Prometheus proxy handler
  - [x] 2.1 `internal/api/prometheus_proxy.go` dosyasını oluştur
  ...
  - [x] 2.2 `isQueryAllowed` ve `validateTimeRange` yardımcı fonksiyonlarını yaz
  ...
  - [x] 2.3 `router.go` Deps yapısını ve route kaydını güncelle
  ...
  - [x] 2.4 `main.go`'ya `PANEL_PROMETHEUS_WIDGET` env var okuma ekle
  ...
  - [x] 2.5 Checkpoint: Go agent derleme ve birim testler
...
- [x] 3. Frontend — tip tanımları ve yardımcılar
  - [x] 3.1 `types/prometheus.ts` oluştur
  ...
  - [x] 3.2 `lib/prometheus.ts` oluştur
  ...
  - [x] 3.3 `hooks/usePrometheusQuery.ts` oluştur
...
- [x] 4. Frontend — monitoring sayfasını yeniden yaz
  - [x] 4.1 `TimeRangeSelector` bileşenini yaz
  ...
  - [x] 4.2 `ChartSection` wrapper bileşenini yaz
  ...
  - [x] 4.3 CPU grafik bileşenlerini yaz
  ...
  - [x] 4.4 Bellek grafik bileşenini yaz
  ...
  - [x] 4.5 Disk I/O grafik bileşenlerini yaz
  ...
  - [x] 4.6 Ağ grafik bileşenlerini yaz
  ...
  - [x] 4.7 Systemd grafik bileşenlerini yaz
  ...
  - [x] 4.8 Termal grafik bileşenini yaz
  ...
  - [x] 4.9 Anlık metrik kartlarını (StatCardRow) yaz
  ...
  - [x] 4.10 `app/monitoring/page.tsx`'i yeniden yaz
...
- [x] 5. Testler
  - [x] 5.1 `lib/prometheus.test.ts` — birim + özellik tabanlı testler
  ...
  - [x] 5.2 `hooks/usePrometheusQuery.test.ts` — birim testler
    - `deriveStep("15m") === 15`, `"1h" === 60`, `"6h" === 300`, `"24h" === 900`
    - _Requirements: 11.3_

  - [x] 5.3 `internal/api/prometheus_proxy_test.go` — Go birim testler
  ...
  - [x] 5.4 PBT testleri — Go (`pgregory.net/rapid`)
